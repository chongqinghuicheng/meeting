package com.cqhc.modules.monitor.config;

import lombok.extern.slf4j.Slf4j;
import com.cqhc.modules.monitor.domain.LogMessage;
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        if(log!=null){
                            // 格式化异常堆栈信息
                            if("ERROR".equals(log.getLevel()) && "com.cqhc.common.exception.handler.GlobalExceptionHandler".equals(log.getClassName())){
